...
{
    int argc = 5;
    char *argv[] = {"corewar", "-dump", "1", "robot1", "robot2"};
    unsigned int arg_index = 1;
    robot_t *robots = init_robots();
...
{
    int argc = 5;
    char *argv[] = {"corewar", "-dump", "-20", "robot1", "robot2"};
    unsigned int arg_index = 1;
    robot_t *robots = init_robots();
...
{
    int argc = 4;
    char *argv[] = {"corewar", "-dump", "120093", "robot1", "robot2"};
    unsigned int arg_index = 1;
    robot_t *robots = init_robots();
...
{
    int argc = 5;
    char *argv[] = {"corewar", "-a", "123273", "robot1", "robot2"};
    unsigned int arg_index = 1;
    robot_t *robots = init_robots();
...
{
    int argc = 5;
    char *argv[] = {"corewar", "-a", "1", "robot1", "robot2"};
    unsigned int arg_index = 1;
    robot_t *robots = init_robots();
